...
<body>
    ...
    <img class="foto1" src="images/eventfoto1.jfif" alt="foto evenement1" heigth="10px">
    <img class="foto2" src="images/eventfoto2.jfif" alt="foto evenement2" heigth="10px">
    <img class="foto3" src="images/eventfoto3.jfif" alt="foto evenement3" heigth="10px">
